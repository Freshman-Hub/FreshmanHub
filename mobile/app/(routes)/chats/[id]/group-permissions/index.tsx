  ...
  const permissionItems = [
    {
      ...
      description:
        "This includes the name, icon, description, disappearing message timer, advanced chat privacy and the ability to pin, keep or unkeep messages.",
      icon: Edit,
    ...
    {
      id: "inviteViaGroupLink",
      title: "Invite via group link",
      description: "",
      icon: Link,
      value: permissions.inviteViaGroupLink,
      section: "members",
    },
    {
